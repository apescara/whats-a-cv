...
- [ ] **P2-01 — Add design tokens.** Define light-theme CSS variables for typography, spacing, color, radius, focus, and Strong/Partial/Gap/Unverified states. Dependencies: P0-09. Check: production web build.
- [ ] **P2-02 — Build the app shell.** Add sidebar, header, main landmark, responsive content region, and skip link. Dependencies: P2-01. Check: keyboard focus reaches skip link and navigation.
- [ ] **P2-03 — Add primary routes.** Create empty routes for Profile, Create CV, Applications, Assistant, Lab, and Settings. Dependencies: P2-02. Check: every sidebar link returns 200.
