...
export default function RecordDetailPage({ params }: { params: Promise<{ kind: string; slug: string }> }) {
  ...
  return (
    <article>
      ...
      {record.role && record.company ? <RecordEditor record={record} kind="experience" /> : record.qualification ? <RecordEditor record={record} kind="education" /> : record.issuer ? <RecordEditor record={record} kind="certifications" /> : record.name ? <RecordEditor record={record} kind="projects" /> : null}
    </article>
  );
}
